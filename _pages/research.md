...
1. **[[FSE'25](https://aashishyadavally.github.io/assets/pdf/pub-fse2025-(1).pdf)]** **CRISPE: Semantic-Guided Execution Planning and Dynamic Reasoning for Enhancing Code Coverage Prediction**
   - Hridya Dhulipala, <span style="text-decoration: underline;">Aashish Yadavally</span>, Smit Patel, Tien N. Nguyen
   - Proceedings of the ACM on Software Engineering (PACMSE), Vol. 2, ACM International Conference on the Foundations of Software Engineering (FSE 2025), Trondheim, Norway, June 23-27, 2025
   - Acceptance Rate: 26.2% (135 out of 515 papers accepted)
  
  
2. **[[FSE'25](https://aashishyadavally.github.io/assets/pdf/pub-fse2025-(2).pdf)]** **Blended Analysis for Predictive Execution**
   - Yi Li, Hridya Dhulipala, <span style="text-decoration: underline;">Aashish Yadavally</span>, Xiaokai Rong, Shaohua Wang, Tien N. Nguyen
   - Proceedings of the ACM on Software Engineering (PACMSE), Vol. 2, ACM International Conference on the Foundations of Software Engineering (FSE 2025), Trondheim, Norway, June 23-27, 2025
   - Acceptance Rate: 26.2% (135 out of 515 papers accepted)
  
  
3. **[[ICSE'25]]** **Planning a Large Language Model for Static Detection of Runtime Errors in Code Snippets**
   - Smit Patel, <span style="text-decoration: underline;">Aashish Yadavally</span>, Hridya Dhulipala, Tien N. Nguyen
...
5. **[[PhD Dissertation](https://aashishyadavally.github.io/assets/pdf/phd-dissertation.pdf)]** **Neural Modeling of Reasoning about Program Behaviors**
   ...
   -  <span style="background-color:#fff8dd; color:#b30000; padding:2px 6px; border-radius:4px; font-size:100%;"> 🏆 <strong style="color:#b30000;">Best Dissertation Award</strong> <br> (only one awardee from the Erik Jonsson School of Engineering and Computer Science in 2025) </span>
...
1. **[[OOPSLA'24](https://aashishyadavally.github.io/assets/pdf/pub-oopsla2024.pdf)]** **A Learning-Based Approach to Static Program Slicing**
   - <span style="text-decoration: underline;">Aashish Yadavally</span>, Yi Li, Shaohua Wang, Tien N. Nguyen
   - Proceedings of the ACM on Programming Languages (PACMPL), Vol. 8, ACM Conference on Object-Oriented Programming, Systems, Languages, and Applications (OOPSLA 2024), Pasadena, California, USA, October 20–25, 2024
   - Acceptance Rate: 38.5% (148 out of 384 papers accepted)
  
  
2. **[[FSE'24](https://aashishyadavally.github.io/assets/pdf/pub-fse2024.pdf)]** **Predictive Program Slicing via Execution Knowledge-Guided Dynamic Dependence Learning**
...
3. **[[FORGE'24](https://aashishyadavally.github.io/assets/pdf/pub-forge2024.pdf)]** **Planning to Guide LLM for Code Coverage Prediction**
   - Hridya Dhulipala, <span style="text-decoration: underline;">Aashish Yadavally</span>, Tien N. Nguyen
   - Proceedings of the 1st IEEE/ACM First International Conference on AI Foundation Models and Software Engineering, Lisbon, Portugal, April 14, 2024
   - Acceptance Rate: 50% (8 out of 16 papers accepted)
  
  
4. **[[ICSE'24]]** **Programming Assistant for Exception Handling with CodeBERT**
   - Yuchen Cai, <span style="text-decoration: underline;">Aashish Yadavally</span>, Abhishek Mishra, Genesis Montejo, Tien N. Nguyen
   - Proceedings of the 46th IEEE/ACM International Conference on Software Engineering, Lisbon, Portugal, April 14-20, 2024
   - Acceptance Rate: 22.3% (234 out of 1049 papers accepted)
  
  
5. **[[ICSE'24-Poster]]** **Poirot: Deep Learning for API Misuse Detection**
    - Yi Li, Tien N. Nguyen, Shaohua Wang, <span style="text-decoration: underline;">Aashish Yadavally</span>
...
6. **[[ICSE'24-Poster]]** **Neural Exception Handling Recommender**
   - Yi Li, Tien N. Nguyen, Yuchen Cai, <span style="text-decoration: underline;">Aashish Yadavally</span>, Abhishek Mishra, Genesis Montejo
   - Proceedings of the 2024 IEEE/ACM 46th International Conference on Software Engineering: Companion Proceedings, Lisbon, Portugal, April 14-20, 2024
...
1. **[[ICSE'23](https://aashishyadavally.github.io/assets/pdf/pub-icse2023-(2).pdf)]** **DeepVD: Toward Class-Separation Features for Neural Network Vulnerability Detection**
   - Wenbo Wang, Tien N. Nguyen, Shaohua Wang, Yi Li, Jiyuan Zhang, <span style="text-decoration: underline;">Aashish Yadavally</span>
...
2. **[[ICSE'23](https://aashishyadavally.github.io/assets/pdf/pub-icse2023-(1).pdf)]** **(Partial) Program Dependence Learning**
...
3. **[[ESEC/FSE'23](https://aashishyadavally.github.io/assets/pdf/pub-esecfse2023-(1).pdf)]** **DeMinify: Neural Variable Name Recovery and Type Inference**
   - Yi Li, <span style="text-decoration: underline;">Aashish Yadavally</span>, Jiaxing Zhang, Shaohua Wang, Tien N. Nguyen
   - Proceedings of the 32nd ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering, San Francisco, California, United States, December 3-9, 2023
   - Acceptance Rate: 27.0% (127 out of 470 papers accepted)
  
  
4. **[[ESEC/FSE'23](https://aashishyadavally.github.io/assets/pdf/pub-esecfse2023-(2).pdf)]** **Commit-Level, Neural Vulnerability Detection and Assessment**
   - Yi Li, <span style="text-decoration: underline;">Aashish Yadavally</span>, Jiaxing Zhang, Shaohua Wang, Tien N. Nguyen
   - Proceedings of the 32nd ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering, San Francisco, California, United States, December 3-9, 2023
   - Acceptance Rate: 27.0% (127 out of 470 papers accepted)
...
1. **[[ASE'22](https://aashishyadavally.github.io/assets/pdf/pub-ase2022-(1).pdf)]** **A Hybrid Approach for Inference between Behavioral Exception API Documentation and Implementations, and Its Applications**
   - Hoan Anh Nguyen, Hung Dang Phan, Syeda Khairunnesa Samantha, Son Nguyen, <span style="text-decoration: underline;">Aashish Yadavally</span>, Shaohua Wang, Hridesh Rajan, Tien N. Nguyen
   - Proceedings of the 37th IEEE/ACM International Conference on Automated Software Engineering, Oakland Center, Michigan, United States, October 10-14, 2022
   - Acceptance Rate: 24.0% (82 out of 337 papers accepted)
  
  
2. **[[ASE'22-NIER](https://aashishyadavally.github.io/assets/pdf/pub-ase2022-(2).pdf)]** **Next Syntactic-Unit Code Completion and Applications**
   - Anh Tuan Nguyen, <span style="text-decoration: underline;">Aashish Yadavally</span>, Tien N. Nguyen
   - Proceedings of the 37th IEEE/ACM International Conference on Automated Software Engineering: Companion Proceedings, Oakland Center, Michigan, United States, October 10-14, 2022
  
  
3. **[[SANER'22](https://aashishyadavally.github.io/assets/pdf/pub-saner2022.pdf)]** **Phrase2Set: Phrase-to-Set Machine Translation and Its Software Engineering Applications**
